  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div>process.env.REACT_APP_ENV_FILE (.env): <b style={{ color: 'orange' }}>-{process.env.REACT_APP_ENV_FILE}-</b> (se toma el env file en tiempo de build)</div>
        ...
        <div>process.env.REACT_APP_ENV_FILE_PROCESS_ENV (process.env.js): <b style={{ color: 'orange' }}>-{process.env.REACT_APP_ENV_FILE_PROCESS_ENV}-</b> (no vale usar process.env... dentro del js)</div>
        ...
        <div>window._env_.REACT_APP_PUBLIC_REACT_ENV_JS (react.env.js - public): <b style={{ color: 'orange' }}>-{window._env_.REACT_APP_PROCESS_ENV_JS}-</b></div>
